...
- 已从GeoServer官网下载GeoServer软件。

- 已在[YashanDB官网下载中心](https://download.yashandb.com/download)下载JDBC驱动包。
- 已向我们的技术支持人员获取gt-jdbc-yashandb方言包。
...
7. 在弹出的【Run/Debug Configuration】对话框中，单击+，按如下配置创建一个新的项目启动项：
...
4. 在窗口标题的运行小部件中选择【Start】，单击右边的运行图标，执行源码运行安装GeoServer。
